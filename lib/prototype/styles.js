...
prototype.prepareStyles = function() {
  ...
  var styles = Object.defineProperties({}, {
    ...
    label: { get: _=> {
      ...
      if (this.state.focused || this.value || this.value === 0) return label.focused
      return label.normal
    }},
  ...
  var classes = Object.defineProperties({}, {
    ...
    container: { get: _=> {
      ...
      let names = 'react-textinput-' + HASH + ' ' + className
      if (this.state.focused || this.value || this.value === 0) {
        names += ' floating'
      }
